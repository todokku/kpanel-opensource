...
<div id="tutoriels" class="tab-pane fade">

	<div class="row">

        <div class="col-md-12">

        	<div class="box-content panel panel-default" align="center">

			<h4 class="box-title panel-heading">Listes des tutoriels</h4>

				<h3><a data-toggle="tab" href="#tuto1">🐍 Zone de Propagation</a></h3>

				<h3><a data-toggle="tab" href="#tuto2"><img src="https://i.imgur.com/GFuljUJ.png" width="25" height="25">&nbsp;&nbsp;Devenir un bon "Manipulateur"</a></h3>

				<h3><a data-toggle="tab" href="#tuto3"><img src="https://i.imgur.com/nrKKIt3.png" width="25" height="25">&nbsp;&nbsp;Comment infecter un addon</a></h3>
...
<div id="tuto1" class="tab-pane fade">
...
<div class="box-content panel panel-default">

<div align="center"><h4 class="box-title panel-heading">🐍 Zone de Propagation</h4></div>

<p class="lead">👀  En tant que membre de kpanel vous pouvez 
...
<div id="tuto2" class="tab-pane fade">
...
<div align="center"><h4 class="box-title panel-heading"><img src="https://i.imgur.com/GFuljUJ.png" width="18" height="18">&nbsp;&nbsp;Devenir un bon "Manipulateur"</h4></div>
...
<div id="tuto3" class="tab-pane fade">
...
<div align="center"><h4 class="box-title panel-heading"><img src="https://i.imgur.com/GFuljUJ.png" width="18" height="18">&nbsp;&nbsp;L'infection d'addon</h4></div>

<p class="lead">Voici les différentes méthode d'ajout d'un serveur dans votre liste kPanel</p>
